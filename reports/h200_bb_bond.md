...
## Outcome
TM 0.480 / 45% at epoch 11 on the 200-protein selection set, against the control's 0.477 / 45% at the same epoch. The bond penalty did exactly what CLAUDE.md section 8 asked for: decoded N-CA scatter fell from 0.39 A (unpenalised control) to 0.10 A by epoch 11, i.e. within a factor of two of what the true latent decodes to (0.06 A). It cost about 0.04 TM in the first epoch while the head re-organised its latents, which was recovered by epoch 8. True-frame FAPE on top of the penalty produced no measurable gain over the Ca pseudo-frame loss: the arms are indistinguishable at the 3.5-point standard error of 200 proteins. Coverage 100% throughout. Held-out (offset 1000, selection-free) score of `best_h200_bb_bond.pt` (epoch 11): TM 0.469, TM>0.5 43%, TM>0.3 88%, RMSD 12.13 A, coverage 100/100. The FAPE control's best checkpoint scores 0.466 / 42% / 11.74 A on the same slice; the inherited checkpoint 0.420 / 29%.
