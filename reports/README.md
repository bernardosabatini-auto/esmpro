...
| [pdb_finetune](pdb_finetune.md) | fine-tune the best checkpoint with 13% experimental PDB targets vs matched control | **null**: control equal or better everywhere (CASP 0.708 vs 0.703); the gain over the warm start (+0.005-0.01, -0.5 A) is from the extra low-rate epochs |
...
| [pf_459M_p128x8_long512](pf_459M_p128x8_long512.md) | first 512-residue stage: warm-started fine-tune on 646k short+long | long val 0.572 / 63% (+0.01 over the 256 model run at 512), long CASP 0.736; **short sets best to date** (held-out 0.770, CASP 0.710) |
| [pf_459M_p128x8_long512_scratch](pf_459M_p128x8_long512_scratch.md) | **new main line**: 512 window from scratch, R=4, late-t, 646k short+long | **best on every set**: held-out 0.785 / 91%, long val 0.591, long CASP 0.763, CASP<=256 0.715; gap to ESMFold2-Fast 0.02-0.03 on CASP |
| [inference_cost](inference_cost.md) | per-protein inference time vs ESMFold2-Fast on the same GPU | **0.32 s at <=256, 0.48 s at 512 (ESMC included) vs 0.84 s and 3.6-3.9 s: 2.6-8x faster** |
| [generative_benchmarks](generative_benchmarks.md) | apo/holo (86), fold-switch (68) ensembles, CAMEO22 (169) vs ESMFold2-Fast and published ensemble models | **TM-ens 0.854 apo/holo (= SimpleFold-100M/AlphaFlow), 0.743 fold-switch (= SimpleFold-3B)**; CAMEO22 0.781 vs ESMFold2-Fast 0.804 |
