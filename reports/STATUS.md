...
Updated 2026-09-23 12:58 (cluster time). Latest per-epoch evaluation of each job; these are selection-set numbers (100 or 200 val proteins), see README for the held-out caveat. Reference: inherited checkpoint 0.427 / 32% / 11.56 A.

| label | kind | job | status | epochs | TM | TM>0.5 | RMSD | coverage |
|---|---|---|---|---|---|---|---|---|
| lf_174M_esmc | latent flow | 47955320 | running 2:32:04 on kempner_rtx | 29 | 0.671 (w=2.0) | 83% | 7.73 | 100% |
